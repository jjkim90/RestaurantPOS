...
![RestaurantPOS overview](docs/gifs/pos-overview.gif)
...
| 테이블 관리 | 주문 관리 |
|---|---|
| ![Table management](docs/images/table-management-overview.png) | ![Order management](docs/images/order-management-overview.png) |
...
메뉴 카테고리와 메뉴 항목을 관리하는 설정 화면입니다.

![Menu settings overview](docs/images/menu-settings-overview.png)

포장, 배달, 대기 주문을 별도 테이블 흐름으로 관리하는 화면입니다.

![System tables overview](docs/images/system-tables-overview.png)
...
![TossPayments WebView](docs/gifs/toss-payment-flow.gif)
...
![Additional order flow](docs/gifs/additional-order-flow.gif)
...
| 결제 선택 | 결제 후 상태 |
|---|---|
| ![Payment dialog](docs/images/payment-dialog.png) | ![Payment complete state](docs/images/payment-complete-state.png) |
...
| 결제 내역 조회 | 취소 및 재결제 처리 |
|---|---|
| ![Payment history overview](docs/images/payment-history-overview.png) | ![Retry or cancel dialog](docs/images/retry-or-cancel-dialog.png) |
...
2. `RestaurantPOS.WPF/appsettings.template.json`을 복사해 `RestaurantPOS.WPF/appsettings.json`을 만들고, 데이터베이스 연결 문자열과 `TossPayments.ClientKey`, `TossPayments.SecretKey`를 입력합니다.
...
- 카드 결제는 TossPayments 테스트용 `ClientKey`/`SecretKey`와 WebView2 환경이 필요합니다.
